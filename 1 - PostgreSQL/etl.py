...
def process_log_file(cur, filepath):
    ...
    col = ('time', 'hour', 'day', 'weekofyear', 'month', 'year', 'weekday')

    dict = {col[0]:time_data[0], col[1]:time_data[1], col[2]:time_data[2], col[3]:time_data[3], col[4]:time_data[4], col[5]:time_data[5], col[6]:time_data[6]}
